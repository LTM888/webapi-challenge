...
- [ ] Mention two parts of Express that you learned about this week.
    We reviwed this week Middleware and Touting which are features of Express.

- [ ] Describe Middleware?
    middleware is the bridge that connects network-based request generated by a client to the back-end data client is requesting.
    
- [ ] Describe a Resource?
   I think of Resources and the page site that the client is trying to reach.

- [ ] What can the API return to help clients know if a request was successful?
     A status code followed by the informaion that was requested.

- [ ] How can we partition our application into sub-applications?
    By adding a express routers .
